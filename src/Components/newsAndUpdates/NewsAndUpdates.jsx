...
//AIzaSyCaOLPlP8g-piUR_FWK03wgwR1PtLm-S9Y
...
const NewsAndUpdates = () => {
  ...
  useEffect(() => {
    const fetchNews = async () => {
      try {
        const response = await fetch(`https://newsapi.org/v2/everything?q=digital literacy&apiKey=a4aed603f5344cd1a600322de2a1e311&pageSize=20`);
        if (!response.ok) {
